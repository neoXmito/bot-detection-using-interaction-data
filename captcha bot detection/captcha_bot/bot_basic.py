...
while i < nb_tries:
    if photo_begin_test():
        ...
        pyautogui.dragTo(900, 390, duration=0.1, button='left', tween=pyautogui.easeInOutQuad)
        #click the begin test button
        pyautogui.click(x=900, y=390)
        time.sleep(0.1)
        #Drawg mouse to text input
        pyautogui.dragTo(900 + 50, 390 + 30, duration=0.1, button='left', tween=pyautogui.easeInOutQuad)
        ...
        pyautogui.dragTo(1170, 420, duration=0.1, button='left', tween=pyautogui.easeInOutQuad)
